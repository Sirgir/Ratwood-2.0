/datum/advclass/sawbones // doctor class. like the pilgrim, but more evil
	...
	traits_applied = list(TRAIT_MEDICINE_EXPERT, TRAIT_NOSTINK, TRAIT_EMPATH, TRAIT_DODGEEXPERT, TRAIT_STEELHEARTED, TRAIT_DECEIVING_MEEKNESS, TRAIT_ALCHEMY_EXPERT, TRAIT_DEATHBYSNUSNU)
	subclass_stats = list(
		STATKEY_INT = 4,
		STATKEY_SPD = 3,
		STATKEY_LCK = 3
